...
minetest.register_node("exchange:shop", {
	...
	tiles = {"default_chest_top.png^exchange_shop_top.png", "default_chest_top.png^default_chest_top.png", "default_chest_lock.png^exchange_shop_side.png"},
...
minetest.register_craft({
	output = 'exchange:shop',
	recipe = {{"exchange:chest"}},
})

minetest.register_craft({
	output = 'exchange:chest',
	recipe = {{"exchange:shop"}},
})
